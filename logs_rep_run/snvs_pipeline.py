...
def run_per_contig_pipeline(sample: Sample, num_cpus: int, results_dir: str, slimeball_dir: str):
    ...
    contest_cmds = [f"bash {contest_script} {chrom} {results_dir} {sample.name} {slimeball_dir} {sample.sample_dir}" for chrom in
            chrom_names()]
    run_as_pool(contest_cmds, num_cpus)
...
def run_msmutect(slimeball:str, tumor_file: str, normal_file: str, num_cpus: int, results_dir: str):
    ...
    msmutect_run = f"{msmutect_path} -l {locus_file} -T {tumor_file} -N {normal_file} -c {num_cpus} -O {output_prefix} -m -A -H"
...
def main(results_dir, samps_dir, slimeball):
    ...
    while True:
        ...
        # sample = Sample("/home/avraham/samples/TCGA-AA-3811",
        #                 "/home/avraham/samples/TCGA-AA-3811/tumor",
        #                 "/home/avraham/samples/TCGA-AA-3811/normal",
        #                 "TCGA-AA-3833-01A-01D-A91V-36.WholeGenome.RP-1657.bam",
        #                 "TCGA-AA-3833-10B-01D-A91V-36.WholeGenome.RP-1657.bam")
