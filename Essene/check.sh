...
# ContEst
echo $JAVA_8 -jar $SLIMEBALL/tools/gatk-3.8/GenomeAnalysisTK.jar \
-T ContEst \
...
#Normal
echo $JAVA_8 -jar $SLIMEBALL/tools/picard/picard.jar CollectGcBiasMetrics \
I=$NORMAL_CONTIG_BAM \
...
echo $JAVA_7 -jar $SLIMEBALL/tools/mutect/bin/mutect.jar \
